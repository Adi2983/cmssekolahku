...
<body>
        ...
        <form id="install">
            ...
            <fieldset>
                ...
                <select id="school_level">
                    ...
                    <option value="6">Sekolah Tinggi</option>
                    <option value="7">Politeknik</option>
                </select>
    ...
    <p>Copyright &copy; 2025 - <?=date('Y');?> MTsN 2 Kotim. All Rights Reserved.</p>
    <p>Powered by <a href="https://mtsnkotim.sch.id">mtsn2kotim.sch.id</a></p>
</body>
</html>
