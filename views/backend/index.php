...
<head>
	...
	<meta name="author" content="Adi Septianto, adiseptianto55@gmail.com">
	<meta name="designer" content="Adi Septianto, adiseptianto55@gmail.com">
	<meta name="reply-to" content="adiseptianto55@gmail.com">
	<meta name="owner" content="Adi Septianto">
	<meta name="url" content="https://www.mtsn2kotim.sch.id">
	<meta name="identifier-URL" content="https://www.mtsn2kotim.sch.id">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="https://www.mtsn2kotim.sch.id" target="_blank"><i class="fa fa-globe"></i> Situs Resmi</a></li>
								<li><a href="https://www.facebook.com/groups/1410751583320326" target="_blank"><i class="fa fa-facebook"></i> Forum Diskusi</a></li>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="modal-body">
							<table class="table table-condensed table-bordered">
								<tbody>
									...
									<tr>
										<td>Author</td>
										<td>:</td>
										<td><a href="https://web.facebook.com/adi.richardo.5">Adi Septianto</a></td>
									</tr>
									<tr>
										<td>Email</td>
										<td>:</td>
									...
									<tr>
										<td>Link</td>
										<td>:</td>
										<td><a href="<?=config_item('website')?>">mtsn2kotim.sch.id</a></td>
									</tr>
									<tr>
										<td>Copyright</td>
										<td>:</td>
							...
							<ol>
								<li>Tidak diperkenankan memperjualbelikan CMS ini tanpa seizin dari <a href="https://www.facebook.com/adi.richardo.5">Pengembang CMS Sekolahku</a>.</li>
